...
│   ├── benchmark-100k.ntro     # Same data in .ntro format
│   ├── benchmark-1m.csv        # 1M rows test data
│   ├── benchmark-1m.ntro
│   ├── benchmark-10m.csv       # 10M rows test data
│   └── benchmark-10m.ntro
...
{
  "benchmark_results": {
    "vega_100k": { loadTime, renderTime, totalTime, memoryBefore, memoryAfter, memoryDelta, timestamp },
    "neutrino_100k": { ... },
    "vega_1m": { ... },
    "neutrino_1m": { ... },
    "vega_10m": { ... },
...
║  📊 Test Configuration                                            ║
║  ┌─────────────────────────────────────────────────────────────┐ ║
║  │ Data Size:  (•) 100K rows   ( ) 1M rows   ( ) 10M rows     │ ║
║  │                                                              │ ║
║  │ [ Run Vega Test ]  [ Run Neutrino Test ]  [ Run Both ]      │ ║
║  │                                                              │ ║
...
2. Generate CSV files for 100K, 1M, 10M rows
